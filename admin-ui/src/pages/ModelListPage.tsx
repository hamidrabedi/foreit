          ...
          <ActionHeader className="flex items-center gap-2">
            {metadata.permissions.add && (
              <Button 
                ...
                onClick={() => navigate({ to: `/admin/${modelName}/new` })}
              ...
              <TableHeader className="bg-muted/30">
                <TableRow className="hover:bg-transparent border-border/50">
                  ...
                  {displayFields.map((fieldName) => {
                    ...
                    return (
                      <TableHead key={fieldName} className="font-bold text-[11px] uppercase tracking-wider text-muted-foreground py-4 min-w-[140px]">
                        ...
                        <div className="flex justify-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                          {metadata.permissions.change && (
                            <Button
                              ...
                              onClick={() => navigate({ to: `/admin/${modelName}/${obj.id}` })}
                            >
