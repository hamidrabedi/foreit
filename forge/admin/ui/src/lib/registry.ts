...
export const CORE_COMPONENTS = {
  ...
  SLOTS: {
    SIDEBAR_TOP: 'forge.slot.sidebar.top',
    SIDEBAR_BOTTOM: 'forge.slot.sidebar.bottom',
    TOPBAR_LEFT: 'forge.slot.topbar.left',
    TOPBAR_RIGHT: 'forge.slot.topbar.right',
    FOOTER: 'forge.slot.footer',
  },
  WIDGETS: {
