...
func (b *PostgreSQLBuilder) BuildUpSQL(changes []types.Change) (string, error) {
...
func (b *PostgreSQLBuilder) BuildDownSQL(changes []types.Change) (string, error) {
	var statements []string
...
func (b *PostgreSQLBuilder) buildChangeUpSQL(change types.Change) (string, error) {
...
func (b *PostgreSQLBuilder) buildChangeDownSQL(change types.Change) (string, error) {
	switch c := change.(type) {
	case *types.CreateTable:
...
func (b *PostgreSQLBuilder) BuildModifyColumn(c *types.ModifyColumn) (string, error) {
...
func (b *PostgreSQLBuilder) buildModifyColumnDown(c *types.ModifyColumn) (string, error) {
...
func (b *PostgreSQLBuilder) BuildCreateTable(c *types.CreateTable) (string, error) {
	return b.baseBuilder.BuildCreateTable(c)
}

// BuildAddColumn delegates to baseBuilder
func (b *PostgreSQLBuilder) BuildAddColumn(c *types.AddColumn) (string, error) {
	return b.baseBuilder.BuildAddColumn(c)
}

// BuildAddIndex delegates to baseBuilder
func (b *PostgreSQLBuilder) BuildAddIndex(c *types.AddIndex) (string, error) {
	return b.baseBuilder.BuildAddIndex(c)
}

// BuildModifyIndex delegates to baseBuilder
func (b *PostgreSQLBuilder) BuildModifyIndex(c *types.ModifyIndex) (string, error) {
	return b.baseBuilder.BuildModifyIndex(c)
}

// BuildAddForeignKey delegates to baseBuilder
func (b *PostgreSQLBuilder) BuildAddForeignKey(c *types.AddForeignKey) (string, error) {
	return b.baseBuilder.BuildAddForeignKey(c)
}

// BuildModifyForeignKey delegates to baseBuilder
func (b *PostgreSQLBuilder) BuildModifyForeignKey(c *types.ModifyForeignKey) (string, error) {
	return b.baseBuilder.BuildModifyForeignKey(c)
}

// BuildAddConstraint delegates to baseBuilder
func (b *PostgreSQLBuilder) BuildAddConstraint(c *types.AddConstraint) (string, error) {
