...
func NewDriftDetector(stateManager schema.StateManager) *DriftDetector {
...
func (d *DriftDetector) DetectDrift(expectedState *schema.SchemaState, actualState *schema.SchemaState) ([]Drift, error) {
	var drifts []Drift
