...
type Operation interface {
	...
	StateForwards(appLabel string, s *state.SchemaState) error

	// DatabaseForwards performs the mutation on the database schema in the forwards direction
	DatabaseForwards(appLabel string, schemaEditor SchemaEditor, fromState, toState *state.SchemaState) error

	// DatabaseBackwards performs the mutation in the reverse direction
	DatabaseBackwards(appLabel string, schemaEditor SchemaEditor, fromState, toState *state.SchemaState) error
