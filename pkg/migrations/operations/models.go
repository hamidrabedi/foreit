...
func (op *CreateModel) StateForwards(appLabel string, s *state.SchemaState) error {
	...
	table := &state.TableState{
		Columns: make(map[string]*state.ColumnState),
	}
	for _, field := range op.Fields {
		table.Columns[field.Name] = &state.ColumnState{
			Name:     field.Name,
			Type:     field.Type,
...
func (op *CreateModel) DatabaseForwards(appLabel string, schemaEditor SchemaEditor, fromState, toState *state.SchemaState) error {
	tableName := op.ModelName
	if dbTable, ok := op.Options["db_table"].(string); ok {
		tableName = dbTable
	}
...
func (op *CreateModel) DatabaseBackwards(appLabel string, schemaEditor SchemaEditor, fromState, toState *state.SchemaState) error {
	tableName := op.ModelName
	if dbTable, ok := op.Options["db_table"].(string); ok {
		tableName = dbTable
	}
...
func (op *DeleteModel) StateForwards(appLabel string, s *state.SchemaState) error {
	delete(s.Tables, op.ModelName)
	return nil
}

// DatabaseForwards drops the table from the database
func (op *DeleteModel) DatabaseForwards(appLabel string, schemaEditor SchemaEditor, fromState, toState *state.SchemaState) error {
	return schemaEditor.DeleteTable(op.ModelName)
}

// DatabaseBackwards recreates the table
func (op *DeleteModel) DatabaseBackwards(appLabel string, schemaEditor SchemaEditor, fromState, toState *state.SchemaState) error {
...
func (op *RenameModel) StateForwards(appLabel string, s *state.SchemaState) error {
...
func (op *RenameModel) DatabaseForwards(appLabel string, schemaEditor SchemaEditor, fromState, toState *state.SchemaState) error {
	return schemaEditor.RenameTable(op.OldName, op.NewName)
}

// DatabaseBackwards reverts the table rename
func (op *RenameModel) DatabaseBackwards(appLabel string, schemaEditor SchemaEditor, fromState, toState *state.SchemaState) error {
...
func (op *AlterModelOptions) StateForwards(appLabel string, s *state.SchemaState) error {
...
func (op *AlterModelOptions) DatabaseForwards(appLabel string, schemaEditor SchemaEditor, fromState, toState *state.SchemaState) error {
	return nil
}

// DatabaseBackwards is a no-op
func (op *AlterModelOptions) DatabaseBackwards(appLabel string, schemaEditor SchemaEditor, fromState, toState *state.SchemaState) error {
	return nil
}
...
func (op *AlterModelTable) StateForwards(appLabel string, s *state.SchemaState) error {
...
// DatabaseForwards renames the table in the database
func (op *AlterModelTable) DatabaseForwards(appLabel string, schemaEditor SchemaEditor, fromState, toState *state.SchemaState) error {
	return schemaEditor.RenameTable(op.OldTable, op.NewTable)
}

// DatabaseBackwards reverts the table rename
func (op *AlterModelTable) DatabaseBackwards(appLabel string, schemaEditor SchemaEditor, fromState, toState *state.SchemaState) error {
