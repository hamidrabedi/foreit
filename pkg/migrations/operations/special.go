...
func (op *RunPython) StateForwards(appLabel string, s *state.SchemaState) error {
	return nil
}

// DatabaseForwards executes the Python/Go code
func (op *RunPython) DatabaseForwards(appLabel string, schemaEditor SchemaEditor, fromState, toState *state.SchemaState) error {
...
func (op *RunPython) DatabaseBackwards(appLabel string, schemaEditor SchemaEditor, fromState, toState *state.SchemaState) error {
	if op.Reverse == nil {
...
func (op *RunSQL) StateForwards(appLabel string, s *state.SchemaState) error {
...
func (op *RunSQL) DatabaseForwards(appLabel string, schemaEditor SchemaEditor, fromState, toState *state.SchemaState) error {
	return schemaEditor.ExecuteSQL(op.SQL)
}

// DatabaseBackwards executes the reverse SQL
func (op *RunSQL) DatabaseBackwards(appLabel string, schemaEditor SchemaEditor, fromState, toState *state.SchemaState) error {
	if op.ReverseSQL == "" {
		return ErrIrreversible
	}
...
func (op *SeparateDatabaseAndState) StateForwards(appLabel string, s *state.SchemaState) error {
...
func (op *SeparateDatabaseAndState) DatabaseForwards(appLabel string, schemaEditor SchemaEditor, fromState, toState *state.SchemaState) error {
...
func (op *SeparateDatabaseAndState) DatabaseBackwards(appLabel string, schemaEditor SchemaEditor, fromState, toState *state.SchemaState) error {
