...
// ManagerV2 provides enhanced type-safe CRUD operations
type ManagerV2[T any] struct {
	tableName string
	schema    *ModelSchema
	db        *db.DB
}

// NewManagerV2 creates a new enhanced manager
func NewManagerV2[T any](tableName string) (*ManagerV2[T], error) {
...
func (m *ManagerV2[T]) SetDB(database *db.DB) {
	m.db = database
}

// GetFieldAccessor returns a field accessor for this model
func (m *ManagerV2[T]) GetFieldAccessor() (*FieldAccessor[T], error) {
	return NewFieldAccessor[T]()
}

// Filter returns a QuerySetV2 for filtering
func (m *ManagerV2[T]) Filter(expr Expression) (QuerySetV2[T], error) {
	qs, err := NewQuerySetV2[T](m.tableName)
	if err != nil {
		return nil, err
	}
	
	if m.db != nil {
		qs = qs.SetDB(m.db).(QuerySetV2[T])
	}
...
func (m *ManagerV2[T]) Get(ctx context.Context, id int64) (*T, error) {
	if m.db == nil {
		return nil, errors.NewNotImplementedError("ManagerV2.Get() - database connection not set")
	}
...
func (m *ManagerV2[T]) All(ctx context.Context) ([]*T, error) {
	qs, err := NewQuerySetV2[T](m.tableName)
	if err != nil {
		return nil, err
	}
...
func (m *ManagerV2[T]) Create(ctx context.Context, instance *T) error {
	if m.db == nil {
		return errors.NewNotImplementedError("ManagerV2.Create() - database connection not set")
	}
...
func (m *ManagerV2[T]) Update(ctx context.Context, instance *T) error {
	if m.db == nil {
		return errors.NewNotImplementedError("ManagerV2.Update() - database connection not set")
	}
...
func (m *ManagerV2[T]) Save(ctx context.Context, instance *T) error {
...
func (m *ManagerV2[T]) Delete(ctx context.Context, instance *T) error {
	if m.db == nil {
		return errors.NewNotImplementedError("ManagerV2.Delete() - database connection not set")
	}
...
func (m *ManagerV2[T]) UpdateFields(ctx context.Context, id int64, updates UpdateMap) error {
