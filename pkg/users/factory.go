...
import (
	...
	"github.com/forgego/forge/pkg/users/backends"
	"github.com/forgego/forge/pkg/users/config"
	"github.com/forgego/forge/pkg/users/repository"
	"github.com/forgego/forge/pkg/users/service"
)

// UserSystem holds all user system components
...
// SetupUserSystem creates and configures the entire user system
func SetupUserSystem(database *db.DB, userConfig *config.UserConfig) (*UserSystem, error) {
